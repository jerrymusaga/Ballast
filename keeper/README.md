...
The ledger client. This package currently decides *what* to propose; submitting it over the
JSON Ledger API, and the live price feed behind it, come with deployment.
